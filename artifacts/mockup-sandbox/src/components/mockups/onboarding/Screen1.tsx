...
// Dark theme: bg #060C18, card #0D1425, primary #6C47FF
    ...
    >
      ...
      <div style={{ width: "100%", height: 44, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px", flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
          <svg width="17" height="12" viewBox="0 0 17 12" fill="none"><rect x="0" y="3" width="3" height="9" rx="1" fill={FG} opacity="0.4"/><rect x="4.5" y="2" width="3" height="10" rx="1" fill={FG} opacity="0.6"/><rect x="9" y="0" width="3" height="12" rx="1" fill={FG}/><rect x="13.5" y="0" width="3" height="12" rx="1" fill={FG} rx="1" opacity="0.3"/></svg>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 32px", gap: 0 }}>
        ...
        <div style={{
          ...
          <img src="/__mockup/images/verbflow-icon.png" alt="VerbFlow" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
        </div>
